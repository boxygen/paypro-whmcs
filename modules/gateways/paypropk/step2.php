<?php
/** paypro.com.pk Payment Gateway WHMCS Module */
...
$paypropkToken = $payload->token;
$paypropkAmount = $payload->amount;
...
if(!$paypropkToken || !$paypropkAmount){
...
$response = paypropk_confirm_transaction($gatewayParams, $paypropkToken, $paypropkAmount);
...
if(!$response->idx){
    error_resp("Payment rejected by PayProPk.");
}
 ...
 */
$paymentAmount = $paypropkAmount / 100.0;
$paymentFee = 0.0;
addInvoicePayment(
    $invoiceId,
    $transactionId,
